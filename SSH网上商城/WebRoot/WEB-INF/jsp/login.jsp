...
<script>
    function changeImg(){
         ...
         checkimg.src="${pageContext.request.contextPath}/checkimg.action?"+new Date().getTime();//可以刷新验证码
    }
</script>
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkimg.action" onclick="changeImg()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
