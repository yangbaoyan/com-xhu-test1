...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
						         <s:iterator var="newpro" value="nplist">
									<li>
										<a href="${pageContext.request.contextPath }/product_getProduct.action?pid=<s:property value="#newpro.pid" />" target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#newpro.image" />" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									
									</li>
								  </s:iterator>	
						</ul>
						<ul class="tabContent" style="display: none;">
